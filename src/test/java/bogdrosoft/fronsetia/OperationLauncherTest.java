 ...
 *
 * Copyright (C) 2023-2026 Bogdan 'bogdro' Drozdowski, bogdro (at) users . sourceforge . net
 *
...
{
	private static final StringEntity RESP;
	...
	*/
	...
	public void testProcessEntity() throws Exception
	{
		...
		assertNotNull(ol.getResponseBody());
	}
